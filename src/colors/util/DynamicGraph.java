...
import colors.util.Graph.Directionality;
import colors.util.Graph.Edge;
import colors.util.Graph.Node;
import colors.util.Graph.SetUpdatingMap;

public class DynamicGraph {
	
	private class TemporallyLimitedObject {
	...
	private class AttributeValue extends TemporallyLimitedObject {
	...
	private class Node extends TemporallyLimitedObject {
		...
		public Node(String id, String label) {
			this.id = id;
			this.label = label;
			this.attributes = new SetUpdatingMap<String,AttributeValue>(nodeAttributeNames);
	...
	private class Edge extends TemporallyLimitedObject {
		private final String id;
		...
		public Edge(final String id, final String node1ID, final String node2ID) {
			...
			this.attributes = new SetUpdatingMap<String,AttributeValue>(edgeAttributeNames);
